...
setup_play(bot, get_state, log, play_next, fetch_info, fetch_playlist, PREFIX, YDL_OPTS)
setup_skip(bot, log)
setup_queue(bot, get_state)
setup_pause(bot, log)
setup_resume(bot, log)
setup_volume(bot, get_state, log)
setup_stop(bot, get_state, log)
setup_leave(bot, get_state, log)
